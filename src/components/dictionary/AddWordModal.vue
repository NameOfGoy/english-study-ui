  ...
  .modal-content {
    ...
    .van-field {
      ...
      :deep(.van-field__label) {
        color: #2c3e50; font-weight: 600; font-size: 15px; letter-spacing: 0.3px;
        font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif;
      }

      :deep(.van-field__control) {
        border-radius: 8px; font-size: 16px; font-weight: 400; color: #34495e; line-height: 1.5;
        font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif;
      }
    ...
    .van-checkbox {
      :deep(.van-checkbox__label) {
        color: #5a6c7d; font-size: 15px; font-weight: 500; letter-spacing: 0.2px;
        font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', sans-serif;
      }
    }
  }
